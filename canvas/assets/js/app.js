...
// import headerFixed from './components/header-fix';
...
(function ($) {
  ...
  $(function () {
    ...
    _popup["default"].init(); // scrollTo.init();
    // headerFixed.init();


    (0, _range["default"])(); // initSelect();

    inputmask(); //headerScroll();
    //tabsToTop();
  });
})(jQuery);
/* ------------------------------------------------------------------------------------------- */
...
},{"./components/accordion":3,"./components/burger-menu":4,"./components/popup":5,"./components/range":6,"./components/select":7,"./components/tabs":8}],3:[function(require,module,exports){
"use strict";
...
var Accordions = /*#__PURE__*/function () {
  function Accordions() {
    ...
    _defineProperty(this, "showAccordion", function (head) {
      ...
      if (head.classList.contains(CLASS_ACTIVE)) {
        ...
        var heightDescription = _this.getDesctiptionHeight(currentContent);
    ...
    this.accordionList = document.querySelectorAll(".".concat(CLASS_ACCORDION));
    this.initAccordions();
  }
  ...
  _createClass(Accordions, [{
    ...
    value: function initAccordions() {
      ...
      if (this.accordionList.length) {
        this.accordionList.forEach(function (accordion) {
          ...
          open.addEventListener('click', function (e) {
            ...
            var group = trigger.nextElementSibling.getAttribute('data-group');

            if (wrap && wrap.getAttribute('data-only')) {
              var contentList = [];
              var contentAll = wrap.querySelectorAll(".".concat(CLASS_CONTENT));
              contentAll.forEach(function (content) {
                var groupContent = content.getAttribute('data-group');

                if (group && group === groupContent) {
              ...
              _this2.showAccordion(trigger, contentList, false);
            } else {
              _this2.showAccordion(trigger);
            }
          });
        });
      }
    ...
    key: "getDesctiptionHeight",
    value: function getDesctiptionHeight(currentAccordion) {
